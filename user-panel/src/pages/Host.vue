        ...
        <div class="container" id="top">
          <div class="col-md-12">
            <div class ="row" style="margin-top: 3rem;">
              <div class ="col">
                <h2 style="color: #484848;">View your hosted engagements</h2>
              </div>
            </div>
            ...
            <div class = "row">
              <div class = "col text-center">
                ...
                <div v-else-if="foundEvents.length == 0" class="text-center">
                  <h4><p style="display: inline-block; font-size: 23px; color: #c91512; font-weight: bold;">Oops!</p> Looks like no upcoming engagements were found</h4>
    ...
    getUpcomingEvents() {
      return this.userEvents.map(event_id=> {
        let event_item=this.allEvents.find(event_item=> {
          if(event_item.id==event_id && event_item.deleted == false) {
