            ...
            <div class="container">
                    ...
                    <div class = "row">
                        <h3 class = "text-center">
                            We're a passionate team of change-agents, engineers, and business people curating meaningful engagements.
                        </h3>
                    </div>
                    <div class = "row">
                            ...
                            <div class = "image-holder">
                                ...
                                <div class = "overlay">
                                    <div class = "text" style = "font-size: 8px;"> 
                                        ...
                                        Djoukeng is a 2020 MBA Candidate at Duke University. He earned his B.S. in Accounting at
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                                ...
                                <div class = "overlay">
                                    <div class = "text"> Travis Nicks is a 2020 Master of Engineering Management and MBA Candidate at Duke University. He earned his B.S. in Ocean Engineering at United State Naval Academy. In the summer of 2019, he interned a Mckinsey & Company as an Strategy Consultant. In 2016 he Cofounded Ignis Kinetics. He worked at the US Navy from 2011 – 2018 as a Nuclear Submarine Officer and Internal Technology Consultant, Office of the Chief of Naval Operations. </div>
                                </div>
                            </div>
                            <h4 class = "title text-center" style = "margin-top: 4px"> Travis Nicks </h4>
                            <h6 class = "text-center"> Strategy </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                                <img src = "img/team/Smyth, Elizabeth.png" class = "about-img" alt =/>
                                <div class = "overlay">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 4px"> Elizabeth Smyth </h4>
                            <h6 class = "text-center"> Strategy </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 10px"> Armon Ghodoussi </h4>
                            <h6 class = "text-center"> Strategy </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class="image-holder">
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 4px"> Ayush Gupta </h4>
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                                <img src = "img/team/Jeffrey He sparc photo.jpg" class = "about-img" id = "row2" alt =/>
                                <div class = "overlay">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 4px"> Jeffrey He </h4>
                            <h6 class = "text-center"> Product </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                                <img src = "img/team/Nishant Kumar.jpg" class = "about-img" id = "row2" alt =/>
                                <div class = "overlay">
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 4px"> Michelle Yang </h4>
                    ...
                    <div class = "row">
                        ...
                        <div class = "col-md-3 ml-auto mr-auto">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 4px"> Lizzet Clifton </h4>
                            <h6 class = "text-center"> Developer </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                    ...
                    <div class = "row">
                        <div class = "col-md-3 ml-auto mr-auto">
                            ...
                            <h4 class = "title text-center" style = "margin-top: 10px"> Jordan Shapiro </h4>
                            <h6 class = "text-center"> Developer </h6>
                        </div>
                        <div class = "col-md-3 ml-auto mr-auto">
                            <div class = "image-holder">
                                <img src = "img/team/avatar.svg" class = "about-img" id = "avatar" alt =/>
                                <div class = "overlay">
                                    <div class = "text"> Katelyn is a sophomore at Duke University. </div>
                                </div>
                            </div>
...
u {
    ...
    border-bottom: 4px solid #0fe031;
}
</style>